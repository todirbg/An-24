...
-- hydraulic system
defineProperty("hydro_press", globalPropertyf("an-24/hydro/main_press")) -- pressure in main system. initial 120 kg per square sm. maximum 160.
...
defineProperty("flaps_valve_emerg", globalPropertyi("an-24/hydro/flaps_valve_emerg")) -- position of emergency flaps valve for gydraulic calculations and animations.
defineProperty("flaps_rotary", globalPropertyi("an-24/hydro/flaps_rotary")) -- position of flaps valve for gydraulic calculations and animations.
...
defineProperty("flap_out_L", globalPropertyf("sim/flightmodel2/wing/flap2_deg[2]")) -- outer flaps left
defineProperty("flap_out_R", globalPropertyf("sim/flightmodel2/wing/flap2_deg[3]")) -- outer flaps right
