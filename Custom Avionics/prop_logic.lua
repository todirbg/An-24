...
defineProperty("uprt1", globalPropertyf("an-24/misc/virt_rud1"))
defineProperty("uprt2", globalPropertyf("an-24/misc/virt_rud2"))
...
defineProperty("apd_work_lit", globalPropertyi("an-24/start/apd_work_lit")) -- lamp for apd

-- controls
defineProperty("pitch_stop", globalPropertyi("an-24/prop/pitch_stop")) -- set up pitch mid stop
defineProperty("feather1_test1", globalPropertyi("an-24/prop/feather1_test1")) -- left prop feather test by IKM
defineProperty("feather2_test1", globalPropertyi("an-24/prop/feather2_test1")) -- right prop feather test by IKM
defineProperty("feather1_test2", globalPropertyi("an-24/prop/feather1_test2")) -- left prop feather test by reverse
defineProperty("feather2_test2", globalPropertyi("an-24/prop/feather2_test2")) -- right prop feather test by reverse
defineProperty("feather1_button", globalPropertyi("an-24/prop/feather1_button")) -- left prop feather button
defineProperty("feather2_button", globalPropertyi("an-24/prop/feather2_button")) -- right prop feather button

defineProperty("feather_test_cap", globalPropertyi("an-24/prop/feather_test_cap")) -- left prop feather test by IKM
defineProperty("pitch_stop_cap", globalPropertyi("an-24/prop/pitch_stop_cap"))
defineProperty("pitch_stop_set", globalPropertyi("an-24/prop/pitch_stop_set")) -- set up pitch mid stop
