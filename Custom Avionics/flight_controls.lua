...
-- wings
defineProperty("ail_set_L", globalPropertyf("sim/flightmodel/controls/wing3l_ail1def")) -- inner aileron left Degrees, positive is trailing-edge down.
defineProperty("ail_set_R", globalPropertyf("sim/flightmodel/controls/wing3r_ail1def")) -- right Degrees, positive is trailing-edge down.
...
-- tail
defineProperty("elevator", globalPropertyf("sim/flightmodel/controls/hstab1_elv1def")) -- Degrees, positive is trailing-edge down.
defineProperty("rudder", globalPropertyf("sim/flightmodel/controls/vstab2_rud1def"))

-- AP mechs
defineProperty("ap_roll_comm", globalPropertyf("an-24/ap/ap_roll_comm"))
defineProperty("ap_pitch_comm", globalPropertyf("an-24/ap/ap_pitch_comm"))
defineProperty("ap_yaw_comm", globalPropertyf("an-24/ap/ap_yaw_comm"))

-- create and define controls datarefs
createProp("an-24/controls/yoke_pitch", "float", 0);  -- commanded pitch. -1 = down, +1 = up
createProp("an-24/controls/yoke_roll", "float", 0);  -- commanded roll. -1 = left, +1 = right
createProp("an-24/controls/yoke_yaw", "float", 0);  -- commanded yaw. -1 = left, +1 = right

defineProperty("yoke_pitch", globalPropertyf("an-24/controls/yoke_pitch"))
defineProperty("yoke_roll", globalPropertyf("an-24/controls/yoke_roll"))
defineProperty("yoke_yaw", globalPropertyf("an-24/controls/yoke_yaw"))
defineProperty("hide_yokes", globalPropertyi("an-24/misc/hide_yokes")) -- show/hide yokes
...
function toggle_yoke_handler(phase)  -- for all commands phase equals: 0 on press; 1 while holding; 2 on release
	if 0 == phase then
...
--[[
rud_stop_command = findCommand("sim/flight_controls/tail_wheel_lock_toggle")
function rud_stop_handler(phase)  -- for all commands phase equals: 0 on press; 1 while holding; 2 on release
	if 0 == phase then
		set(rud_stopor, math.abs(get(rud_stopor) - 1))
	end
return 0
end
registerCommandHandler(rud_stop_command, 0, rud_stop_handler)
--]]
