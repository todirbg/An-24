...
-- sources
defineProperty("obs1_fromto", globalPropertyi("an-24/gauges/obs1_fromto")) -- obs from-to switcher
defineProperty("obs2_fromto", globalPropertyi("an-24/gauges/obs2_fromto")) -- obs from-to switcher
defineProperty("sp_ils", globalPropertyi("an-24/gauges/sp_ils")) -- switcher between SP-50 and ILS system
...
-- result
defineProperty("k1_flag", globalPropertyi("an-24/gauges/k1_flag")) -- flag for course on left kppm
defineProperty("k2_flag", globalPropertyi("an-24/gauges/k2_flag")) -- flag for course on right kppm
defineProperty("g1_flag", globalPropertyi("an-24/gauges/g1_flag")) -- flag for glide on left kppm
defineProperty("g2_flag", globalPropertyi("an-24/gauges/g2_flag")) -- flag for glide on right kppm
defineProperty("curs_1", globalPropertyf("an-24/gauges/curs_1")) -- KursMP course for left kppm
defineProperty("curs_2", globalPropertyf("an-24/gauges/curs_2")) -- KursMP course for right kppm
defineProperty("glide_1", globalPropertyf("an-24/gauges/glide_1")) -- KursMP glide for left kppm
defineProperty("glide_2", globalPropertyf("an-24/gauges/glide_2")) -- KursMP glide for right kppm

defineProperty("vor_1", globalPropertyf("an-24/gauges/vor_1")) -- KursMP course for left kppm
defineProperty("vor_2", globalPropertyf("an-24/gauges/vor_2")) -- KursMP course for right kppm

defineProperty("obs1_fromto_lit", globalPropertyi("an-24/gauges/obs1_fromto_lit")) -- Nav-To-From indication, nav1, pilot, 0 is flag, 1 is to, 2 is from.
defineProperty("obs2_fromto_lit", globalPropertyi("an-24/gauges/obs2_fromto_lit")) -- Nav-To-From indication, nav1, pilot, 0 is flag, 1 is to, 2 is from.
